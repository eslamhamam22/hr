                ...
                data: {
                    ...
                    datasets: [
                        ...
                        },
                        {
                            ...
                            data: dash.monthlyTrend.map(t => t.workFromHomeRequests).reverse(),
                            backgroundColor: '#36b9cc'
                        },
                        {
                            label: 'Time Off Requests',
                            data: dash.monthlyTrend.map(t => t.timeOffRequests).reverse(),
            ...
            this.charts.push(new Chart(deptCtx, {
                ...
                data: {
                    ...
                    datasets: [
                        {
                            label: 'Leave',
                            data: dash.requestsByDepartment.map(d => d.leaveRequests),
                            backgroundColor: '#4e73df'
                        },
                        {
                            label: 'Overtime',
                            data: dash.requestsByDepartment.map(d => d.overtimeRequests),
                            backgroundColor: '#1cc88a'
                        },
                        {
                            label: 'Work From Home',
                            data: dash.requestsByDepartment.map(d => d.workFromHomeRequests),
                            backgroundColor: '#36b9cc'
                        },
                        {
                            label: 'Time Off',
                            data: dash.requestsByDepartment.map(d => d.timeOffRequests),
                            backgroundColor: '#f6c23e'
                        }
                    ]
                },
            ...
            this.charts.push(new Chart(sysTrendCtx, {
                ...
                data: {
                    ...
                    datasets: [
                        ...
                        {
                            label: 'Work From Home',
                            data: dash.systemMonthlyTrend.map(t => t.workFromHomeRequests).reverse(),
                            borderColor: '#36b9cc',
                            tension: 0.1
                        },
                        {
                            label: 'Time Off',
                            data: dash.systemMonthlyTrend.map(t => t.timeOffRequests).reverse(),
                            borderColor: '#f6c23e',
                            tension: 0.1
                        }
                    ]
